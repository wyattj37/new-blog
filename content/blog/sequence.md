...
### Four Games Later 
That's a W folks. It wasn't a clean win, but as I suspected with the Two-Eyed Jack advantage it got the job done. Even with a bug I forgot to fix that kept the winning move from being played for 3 or 4 turns. Once I fix that I'll upload to my [GitHub](https://github.com/wyattj37) with instructions how to use it - it's a little janky but the computer really does do all the decision making.
