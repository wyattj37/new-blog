...
The question becomes what just happened between $x = 0$ and $x = 12$? Turns out, that needs to be calculated by hand. I've uploaded the script I wrote to do exactly that on my [GitHub](https://github.com/wyattj37). Because of the periodic nature, though, you can really create any sort of repeating pattern you want. All you have to do is adjust $a_0, b_0, p, q$ and $l$.
